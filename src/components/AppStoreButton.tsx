...
const APP_STORE_URL = 'https://apps.apple.com/app/studypod-ai/id6740000000';
...
export default function AppStoreButton({ className = '' }: { className?: string }) {
  return (
    <Link
      ...
      className={`inline-flex items-center gap-2.5 bg-white text-black rounded-lg px-4 py-2.5 hover:bg-gray-100 transition-colors ${className}`}
    >
